...
<input type="text" id="nomJuge" name="nomJuge"
	value="<c:out value="${juge.nom}"/>" size="30" maxlength="30" />
<span class="erreur">${form.erreurs['nomJuge']}</span>
<br />

<label for="prenomJuge">Prénom<span class="requis">*</span></label>
<input type="text" id="prenomJuge" name="prenomJuge"
	value="<c:out value="${juge.prenom}"/>" size="30" maxlength="30" />
...
<label for="validmdpJuge">Confirmation du mots de passe<span
	class="requis">*</span></label>
<input type="password" id="validmdpJuge" name="validmdpJuge" value=""
